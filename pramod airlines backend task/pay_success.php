...
body {
  ...
  background: -webkit-linear-gradient(to right, #7F7FD5 , #91EAE4);  /* Chrome 10-25, Safari 5.1-6 */
  background: linear-gradient(to right, #7F7FD5 , #91EAE4); /* W3C, IE 10+/ Edge, Firefox 16+, Chrome 26+, Opera 12+, Safari 7+ */
