...
background: -webkit-linear-gradient(to left, #2A5470 ,#4C4177);  /* Chrome 10-25, Safari 5.1-6 */
background: linear-gradient(to left, #2A5470 ,#4C4177); /* W3C, IE 10+/ Edge, Firefox 16+, Chrome 26+, Opera 12+, Safari 7+ */
